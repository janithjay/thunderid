...
func (_mock *UserServiceInterfaceMock) UpdateSelfUserCredentials(ctx context.Context, userID string, updates map[string]user.CredentialUpdate) *common.ServiceError {
	...
	var r0 *common.ServiceError
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, map[string]user.CredentialUpdate) *common.ServiceError); ok {
...
//   - ctx context.Context
//   - userID string
//   - updates map[string]user.CredentialUpdate
func (_e *UserServiceInterfaceMock_Expecter) UpdateSelfUserCredentials(ctx interface{}, userID interface{}, updates interface{}) *UserServiceInterfaceMock_UpdateSelfUserCredentials_Call {
	return &UserServiceInterfaceMock_UpdateSelfUserCredentials_Call{Call: _e.mock.On("UpdateSelfUserCredentials", ctx, userID, updates)}
}

func (_c *UserServiceInterfaceMock_UpdateSelfUserCredentials_Call) Run(run func(ctx context.Context, userID string, updates map[string]user.CredentialUpdate)) *UserServiceInterfaceMock_UpdateSelfUserCredentials_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		...
		var arg2 map[string]user.CredentialUpdate
		if args[2] != nil {
			arg2 = args[2].(map[string]user.CredentialUpdate)
		}
		run(
			arg0,
			arg1,
...
func (_c *UserServiceInterfaceMock_UpdateSelfUserCredentials_Call) RunAndReturn(run func(ctx context.Context, userID string, updates map[string]user.CredentialUpdate) *common.ServiceError) *UserServiceInterfaceMock_UpdateSelfUserCredentials_Call {
	_c.Call.Return(run)
	return _c
}
