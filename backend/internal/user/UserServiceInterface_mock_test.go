...
func (_mock *UserServiceInterfaceMock) UpdateSelfUserCredentials(ctx context.Context, userID string, credentials json.RawMessage) *common.ServiceError {
...
func (_e *UserServiceInterfaceMock_Expecter) UpdateSelfUserCredentials(ctx interface{}, userID interface{}, credentials interface{}) *UserServiceInterfaceMock_UpdateSelfUserCredentials_Call {
	return &UserServiceInterfaceMock_UpdateSelfUserCredentials_Call{Call: _e.mock.On("UpdateSelfUserCredentials", ctx, userID, credentials)}
}

func (_c *UserServiceInterfaceMock_UpdateSelfUserCredentials_Call) Run(run func(ctx context.Context, userID string, credentials json.RawMessage)) *UserServiceInterfaceMock_UpdateSelfUserCredentials_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *UserServiceInterfaceMock_UpdateSelfUserCredentials_Call) RunAndReturn(run func(ctx context.Context, userID string, credentials json.RawMessage) *common.ServiceError) *UserServiceInterfaceMock_UpdateSelfUserCredentials_Call {
	_c.Call.Return(run)
	return _c
}
