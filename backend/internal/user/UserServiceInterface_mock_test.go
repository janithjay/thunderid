...
func (_mock *UserServiceInterfaceMock) UpdateSelfUserCredentials(ctx context.Context, userID string, updates map[string]CredentialUpdate) *common.ServiceError {
	...
	var r0 *common.ServiceError
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, map[string]CredentialUpdate) *common.ServiceError); ok {
...
func (_c *UserServiceInterfaceMock_UpdateSelfUserCredentials_Call) Run(run func(ctx context.Context, userID string, updates map[string]CredentialUpdate)) *UserServiceInterfaceMock_UpdateSelfUserCredentials_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		...
		var arg2 map[string]CredentialUpdate
		if args[2] != nil {
			arg2 = args[2].(map[string]CredentialUpdate)
		}
		run(
			arg0,
			arg1,
...
func (_c *UserServiceInterfaceMock_UpdateSelfUserCredentials_Call) RunAndReturn(run func(ctx context.Context, userID string, updates map[string]CredentialUpdate) *common.ServiceError) *UserServiceInterfaceMock_UpdateSelfUserCredentials_Call {
	_c.Call.Return(run)
	return _c
}
